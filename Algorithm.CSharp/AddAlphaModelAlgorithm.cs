...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class AddAlphaModelAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.91%"},
            {"Average Loss", "-0.23%"},
            {"Compounding Annual Return", "214.726%"},
            {"Drawdown", "1.600%"},
            {"Expectancy", "2.251"},
            {"Net Profit", "1.583%"},
            {"Sharpe Ratio", "3.021"},
            {"Probabilistic Sharpe Ratio", "61.785%"},
            {"Loss Rate", "33%"},
            {"Win Rate", "67%"},
            {"Profit-Loss Ratio", "3.88"},
            {"Alpha", "1.073"},
            {"Beta", "-0.291"},
            {"Annual Standard Deviation", "0.272"},
            {"Annual Variance", "0.074"},
            {"Information Ratio", "-0.107"},
            {"Tracking Error", "0.364"},
            {"Treynor Ratio", "-2.822"},
            {"Total Fees", "$10.88"},
            {"Fitness Score", "0.384"},
            {"Kelly Criterion Estimate", "16.447"},
            {"Kelly Criterion Probability Value", "0.315"},
            {"Sortino Ratio", "16.575"},
            {"Return Over Maximum Drawdown", "135.486"},
            {"Portfolio Turnover", "0.385"},
