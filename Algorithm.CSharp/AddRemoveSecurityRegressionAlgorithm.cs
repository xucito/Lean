...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class AddRemoveSecurityRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Estimated Monthly Alpha Value", "$36952.1317"},
            {"Total Accumulated Estimated Alpha Value", "$5953.3990"},
            {"Mean Population Estimated Insight Value", "$2976.6995"},
