...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CoarseFundamentalTop3Algorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Total Fees", "$11.63"},
            {"Fitness Score", "0.013"},
            {"Kelly Criterion Estimate", "-7.017"},
            {"Kelly Criterion Probability Value", "0.607"},
            {"Sortino Ratio", "-5.1"},
            {"Return Over Maximum Drawdown", "-11.717"},
            {"Portfolio Turnover", "0.282"},
            {"Total Insights Generated", "11"},
            {"Total Insights Closed", "7"},
            {"Total Insights Analysis Completed", "7"},
            {"Long Insight Count", "7"},
            {"Short Insight Count", "0"},
            {"Long/Short Ratio", "100%"},
            {"Estimated Monthly Alpha Value", "$617601.8378"},
            {"Total Accumulated Estimated Alpha Value", "$312232.0402"},
            {"Mean Population Estimated Insight Value", "$44604.5772"},
            {"Mean Population Direction", "16.6667%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "1.941%"},
