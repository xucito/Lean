...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CustomDataUsingMapFileRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "-99.912%"},
            {"Drawdown", "10.700%"},
            {"Expectancy", "0"},
            {"Net Profit", "-10.346%"},
            {"Sharpe Ratio", "-8.596"},
            {"Probabilistic Sharpe Ratio", "0.281%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-6.44"},
            {"Beta", "-8.003"},
            {"Annual Standard Deviation", "0.763"},
            {"Annual Variance", "0.582"},
            {"Information Ratio", "-7.826"},
            {"Tracking Error", "0.84"},
            {"Treynor Ratio", "0.819"},
            {"Total Fees", "$0.00"},
            {"Fitness Score", "0.127"},
            ...
            {"Return Over Maximum Drawdown", "-9.376"},
