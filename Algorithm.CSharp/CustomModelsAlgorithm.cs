...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CustomModelsAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Information Ratio", "-4.285"},
            {"Tracking Error", "0.118"},
            {"Treynor Ratio", "-0.614"},
            {"Total Fees", "$62.24"},
            {"Fitness Score", "0.147"},
            {"Kelly Criterion Estimate", "30.363"},
            {"Kelly Criterion Probability Value", "0.161"},
            {"Sortino Ratio", "-2.792"},
            ...
            {"Estimated Monthly Alpha Value", "$523111.7024"},
            {"Total Accumulated Estimated Alpha Value", "$537642.5830"},
            {"Mean Population Estimated Insight Value", "$5843.9411"},
            {"Mean Population Direction", "27.1739%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "34.4672%"},
