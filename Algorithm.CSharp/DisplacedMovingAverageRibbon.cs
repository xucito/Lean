...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class DisplacedMovingAverageRibbon : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Total Fees", "$46.75"},
            {"Fitness Score", "0.002"},
            {"Kelly Criterion Estimate", "4.424"},
            {"Kelly Criterion Probability Value", "0.317"},
            {"Sortino Ratio", "1.607"},
            ...
            {"Estimated Monthly Alpha Value", "$1533923.2480"},
            {"Total Accumulated Estimated Alpha Value", "$112038180.1243"},
            {"Mean Population Estimated Insight Value", "$18673030.0207"},
