...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class FractionalQuantityRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.63%"},
            {"Average Loss", "-2.39%"},
            {"Compounding Annual Return", "82.899%"},
            {"Drawdown", "6.500%"},
            {"Expectancy", "-0.158"},
            {"Net Profit", "0.664%"},
            {"Sharpe Ratio", "1.027"},
            {"Probabilistic Sharpe Ratio", "50.119%"},
            {"Loss Rate", "33%"},
            {"Win Rate", "67%"},
            {"Profit-Loss Ratio", "0.26"},
            {"Alpha", "0"},
            {"Beta", "0"},
            {"Annual Standard Deviation", "0.852"},
            {"Annual Variance", "0.725"},
            {"Information Ratio", "0"},
            {"Tracking Error", "0"},
            {"Treynor Ratio", "0"},
            {"Total Fees", "$2429.02"},
            {"Fitness Score", "0.857"},
            {"Kelly Criterion Estimate", "3.965"},
            {"Kelly Criterion Probability Value", "0.361"},
            {"Sortino Ratio", "1.632"},
            {"Return Over Maximum Drawdown", "12.842"},
            {"Portfolio Turnover", "1.995"},
            ...
            {"Estimated Monthly Alpha Value", "$25604.9368"},
            {"Total Accumulated Estimated Alpha Value", "$3413.9916"},
            {"Mean Population Estimated Insight Value", "$682.7983"},
            {"Mean Population Direction", "40%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "49.0099%"},
