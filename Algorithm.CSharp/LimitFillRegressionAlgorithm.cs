...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class LimitFillRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Sortino Ratio", "6.529"},
            {"Return Over Maximum Drawdown", "40.391"},
            ...
            {"Estimated Monthly Alpha Value", "$215698.0783"},
            {"Total Accumulated Estimated Alpha Value", "$34751.3571"},
            {"Mean Population Estimated Insight Value", "$1053.0714"},
