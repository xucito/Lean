...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class MarginCallClosedMarketRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Estimated Monthly Alpha Value", "$14358.3729"},
            {"Total Accumulated Estimated Alpha Value", "$2313.2934"},
            {"Mean Population Estimated Insight Value", "$2313.2934"},
