...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class MarginCallClosedMarketRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.39%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "1673.482%"},
            {"Drawdown", "5.500%"},
            {"Expectancy", "0"},
            {"Net Profit", "3.745%"},
            {"Sharpe Ratio", "4.876"},
            {"Probabilistic Sharpe Ratio", "67.252%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.023"},
            ...
            {"Return Over Maximum Drawdown", "210.165"},
            ...
            {"Estimated Monthly Alpha Value", "$53553.1115"},
            {"Total Accumulated Estimated Alpha Value", "$8628.0013"},
            {"Mean Population Estimated Insight Value", "$8628.0013"},
