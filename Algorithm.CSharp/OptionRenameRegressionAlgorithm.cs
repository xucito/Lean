...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionRenameRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Return Over Maximum Drawdown", "20.207"},
            ...
            {"Estimated Monthly Alpha Value", "$-3388.86"},
            {"Total Accumulated Estimated Alpha Value", "$-545.983"},
            {"Mean Population Estimated Insight Value", "$-272.9915"},
