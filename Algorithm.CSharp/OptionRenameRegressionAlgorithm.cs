...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OptionRenameRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Total Fees", "$4.00"},
            {"Fitness Score", "0.001"},
            {"Kelly Criterion Estimate", "-0.932"},
            {"Kelly Criterion Probability Value", "0.688"},
            {"Sortino Ratio", "79228162514264337593543950335"},
            {"Return Over Maximum Drawdown", "-1.361"},
            ...
            {"Estimated Monthly Alpha Value", "$-3596.791"},
            {"Total Accumulated Estimated Alpha Value", "$-579.483"},
            {"Mean Population Estimated Insight Value", "$-289.7415"},
