...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OrderBasedInsightGeneratedAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.21%"},
            {"Average Loss", "-0.04%"},
            {"Compounding Annual Return", "112.221%"},
            {"Drawdown", "0.900%"},
            {"Expectancy", "2.328"},
            {"Net Profit", "2.505%"},
            {"Sharpe Ratio", "6.548"},
            {"Probabilistic Sharpe Ratio", "86.364%"},
            {"Loss Rate", "50%"},
            {"Win Rate", "50%"},
            {"Profit-Loss Ratio", "5.66"},
            {"Alpha", "0.447"},
            {"Beta", "0.131"},
            {"Annual Standard Deviation", "0.087"},
            {"Annual Variance", "0.008"},
            {"Information Ratio", "-2.426"},
            {"Tracking Error", "0.153"},
            {"Treynor Ratio", "4.342"},
            {"Total Fees", "$13.18"},
            {"Fitness Score", "0.324"},
            {"Kelly Criterion Estimate", "21.673"},
            {"Kelly Criterion Probability Value", "0.282"},
            {"Sortino Ratio", "13.627"},
            {"Return Over Maximum Drawdown", "130.687"},
            ...
            {"Estimated Monthly Alpha Value", "$9915621.0755"},
            {"Total Accumulated Estimated Alpha Value", "$4021335.2140"},
            {"Mean Population Estimated Insight Value", "$670222.5357"},
