...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class RawPricesUniverseRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Treynor Ratio", "-13.342"},
            {"Total Fees", "$0.00"},
            {"Fitness Score", "0.071"},
            {"Kelly Criterion Estimate", "-59.48"},
            {"Kelly Criterion Probability Value", "0.899"},
            {"Sortino Ratio", "-1.237"},
            ...
            {"Estimated Monthly Alpha Value", "$-3523675"},
            {"Total Accumulated Estimated Alpha Value", "$-1781413"},
            {"Mean Population Estimated Insight Value", "$-84829.21"},
