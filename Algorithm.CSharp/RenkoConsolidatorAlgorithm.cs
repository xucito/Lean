...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class RenkoConsolidatorAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Treynor Ratio", "-26.087"},
            {"Total Fees", "$117.46"},
            {"Fitness Score", "0.044"},
            {"Kelly Criterion Estimate", "-1.533"},
            {"Kelly Criterion Probability Value", "0.547"},
            {"Sortino Ratio", "-0.219"},
            ...
            {"Estimated Monthly Alpha Value", "$-209593"},
            {"Total Accumulated Estimated Alpha Value", "$-2558490"},
            {"Mean Population Estimated Insight Value", "$-91374.66"},
