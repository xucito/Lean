...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class SetAccountCurrencySecurityMarginModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Information Ratio", "-3.781"},
            {"Tracking Error", "0.184"},
            {"Treynor Ratio", "-1.38"},
            {"Total Fees", "$12.97"},
            {"Fitness Score", "0.031"},
            {"Kelly Criterion Estimate", "35.227"},
            {"Kelly Criterion Probability Value", "0.227"},
            {"Sortino Ratio", "-3.761"},
            ...
            {"Estimated Monthly Alpha Value", "€16576586.9993"},
            {"Total Accumulated Estimated Alpha Value", "€5088091.2873"},
            {"Mean Population Estimated Insight Value", "€1017618.2575"},
