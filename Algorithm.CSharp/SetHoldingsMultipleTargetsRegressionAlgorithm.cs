...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class SetHoldingsMultipleTargetsRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Estimated Monthly Alpha Value", "$23213.0041"},
            {"Total Accumulated Estimated Alpha Value", "$3739.8729"},
            {"Mean Population Estimated Insight Value", "$623.3121"},
