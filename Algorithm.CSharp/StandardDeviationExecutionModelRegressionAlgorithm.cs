...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class StandardDeviationExecutionModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.04%"},
            {"Average Loss", "0.00%"},
            {"Compounding Annual Return", "1273.792%"},
            {"Drawdown", "0.600%"},
            {"Expectancy", "44.608"},
            {"Net Profit", "3.407%"},
            {"Sharpe Ratio", "10.902"},
            {"Probabilistic Sharpe Ratio", "99.765%"},
            {"Loss Rate", "1%"},
            {"Win Rate", "99%"},
            {"Profit-Loss Ratio", "45.14"},
            {"Alpha", "1.274"},
            {"Beta", "0.799"},
            {"Annual Standard Deviation", "0.196"},
            {"Annual Variance", "0.038"},
            {"Information Ratio", "10.875"},
            ...
            {"Return Over Maximum Drawdown", "24290.404"},
