...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class UniverseSelectionRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Net Profit", "-6.115%"},
            {"Sharpe Ratio", "-3.746"},
            {"Probabilistic Sharpe Ratio", "11.866%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-1.113"},
            ...
            {"Estimated Monthly Alpha Value", "$7412.3650"},
            {"Total Accumulated Estimated Alpha Value", "$4241.52"},
            {"Mean Population Estimated Insight Value", "$4241.52"},
