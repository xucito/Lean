...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class UniverseSharingSubscriptionRequestRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Information Ratio", "-1.153"},
            {"Tracking Error", "0.131"},
            {"Treynor Ratio", "4.056"},
            {"Total Fees", "$48.51"},
            {"Fitness Score", "0.562"},
            {"Kelly Criterion Estimate", "11.795"},
            {"Kelly Criterion Probability Value", "0.377"},
            {"Sortino Ratio", "7.674"},
            ...
            {"Estimated Monthly Alpha Value", "$2862436.7771"},
            {"Total Accumulated Estimated Alpha Value", "$2878339.2036"},
            {"Mean Population Estimated Insight Value", "$205595.6574"},
            {"Mean Population Direction", "29.8035%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "5.7107%"},
