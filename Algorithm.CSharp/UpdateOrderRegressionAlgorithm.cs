...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class UpdateOrderRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Information Ratio", "-2.129"},
            {"Tracking Error", "0.111"},
            {"Treynor Ratio", "-1.823"},
            {"Total Fees", "$21.00"},
            {"Fitness Score", "0.002"},
            {"Kelly Criterion Estimate", "-8.619"},
            ...
            {"Long/Short Ratio", "0%"},
            {"Estimated Monthly Alpha Value", "$-4196137"},
            {"Total Accumulated Estimated Alpha Value", "$-102135100"},
            {"Mean Population Estimated Insight Value", "$-5106757"},
