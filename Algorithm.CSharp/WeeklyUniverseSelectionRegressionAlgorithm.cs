...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class WeeklyUniverseSelectionRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Information Ratio", "-4.736"},
            {"Tracking Error", "0.113"},
            {"Treynor Ratio", "-0.509"},
            {"Total Fees", "$25.73"},
            {"Fitness Score", "0.049"},
            {"Kelly Criterion Estimate", "-48.838"},
            {"Kelly Criterion Probability Value", "0.728"},
            {"Sortino Ratio", "-2.32"},
            ...
            {"Estimated Monthly Alpha Value", "$-15822.06"},
            {"Total Accumulated Estimated Alpha Value", "$-16261.57"},
            {"Mean Population Estimated Insight Value", "$-2323.081"},
